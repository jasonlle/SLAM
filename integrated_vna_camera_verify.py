...
from scpiworkbench import support_functions as sf
...
# Save folders
BASE_SAVE_DIR = r"C:\Users\ericd\Desktop\dataset"
EMPTY_DIR = os.path.join(BASE_SAVE_DIR, "emptyroom")
OCCUPIED_DIR = os.path.join(BASE_SAVE_DIR, "occupiedroom")
